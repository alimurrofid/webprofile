export const experiences = [
  ...
  { 
    ...
    descriptions: [
      "Ini adalah deskripsi untuk Pengurus Muda Divisi Keagamaan.",
      "Bertanggung jawab atas kegiatan keagamaan organisasi.",
      "Mengelola acara dan pertemuan rutin."
    ]
  },
  { 
    ...
    descriptions: [
      "Deskripsi untuk pengalaman ketiga.",
      "Poin kedua untuk pengalaman ketiga.",
      "Poin ketiga untuk pengalaman ketiga."
    ]
  },
  { 
    ...
    descriptions: [
      "Deskripsi untuk pengalaman keempat.",
      "Poin kedua untuk pengalaman keempat."
    ]
  },
  { 
    ...
    descriptions: [
      "Deskripsi untuk pengalaman kelima.",
      "Poin kedua untuk pengalaman kelima."
    ]
  }
];